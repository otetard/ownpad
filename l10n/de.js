OC.L10N.register(
    ...
    "Ownpad is not correctly configured, you should update your configuration. Please refer to the documentation for more information." : "Ownpad ist nicht richtig konfiguriert. Aktualisiere die Konfiguration. Weitere Informationen findest du in der Dokumentation.",
    ...
    "Token-based pads are safest, especially for protected pads. Keep migration mode only as long as needed, then switch back to token-based mode." : "Token-basierte Pads sind am sichersten, besonders bei geschützten Pads. Nutze den Migrationsmodus nur so lange wie nötig und wechsle danach zurück.",
    ...
    "Use the radio choice per group to select the file that should become the valid mapping, then apply all selections once." : "Wähle pro Gruppe per Radio-Button die Datei aus, die als gültiges Mapping gesetzt werden soll, und wende danach alle Auswahlen gemeinsam an.",
