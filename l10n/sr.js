OC.L10N.register(
    ...
    "Use Etherpad API" : "Користи Etherpad API",
    ...
    "Etherpad authentication Client ID" : "ID клијента за Etherpad проверу идентитета",
    ...
    "Authentication to Etherpad successful!" : "Успела је потврда идентитета за Etherpad!",
    ...
    "Created new Etherpad document “{name}”" : "Креиран је нови Etherpad документ „{name}”",
    "Error: {error}" : "Грешка: {error}",
    "Pad" : "Бележница",
    "New pad.pad" : "Нови pad.pad",
    "Protected Pad" : "Заштићени pad",
    "New protected pad.pad" : "Нови заштићени pad.pad",
    "Calc" : "Calc",
