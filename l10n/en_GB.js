OC.L10N.register(
    ...
    "Allow tokenless pads for all pad types (migration mode)" : "Allow tokenless pads for all pad types (migration mode)",
    "Token-based pads are safest, especially for protected pads. Keep migration mode only as long as needed, then switch back to token-based mode." : "Token-based pads are safest, especially for protected pads. Keep migration mode only as long as needed, then switch back to token-based mode.",
