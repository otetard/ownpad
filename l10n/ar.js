OC.L10N.register(
    ...
    "Unable to communicate with Etherpad API." : "تعذّر الاتصال بـ API الخاص بـ Etherpad",
    ...
    "Ownpad" : "Ownpad",
    "\n    Create and open Etherpad and Ethercalc documents.\n  " : "\n    أنشِيءْ و افتَح مستندات Etherpad و Ethercalc.\n  ",
    "Ownpad is a Nextcloud application that allows to create and open\n    Etherpad and Ethercalc documents.\n\n    This application requires to have access to an instance of\n    Etherpad and/or Ethercalc to work properly." : "Ownpad هو أحد تطبيقات نكست كلاود يسمح بإنشاء و فتح مستندات Etherpad و Ethercalc. \n\nيتطلب هذا التطبيق الوصول إلى خادوم Etherpad و/أو Ethercalc للعمل بشكل صحيح.",
    "Pad" : "كُرّاس نصوص Pad",
    ...
    "You have to host your Etherpad instance in a subdomain or sibbling domain of the one that is used by Nextcloud (due to cookie isolation)." : "يجب عليك استضافة مثيل Etherpad الخاص بك في نطاق فرعي subdomain  أو نطاق شقيق للنطاق sibbling domain الذي تستخدمه نكست كلاود (بسبب عزل ملفات تعريف الارتباط cookie isolation).",
