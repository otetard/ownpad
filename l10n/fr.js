OC.L10N.register(
    ...
    "Ownpad" : "Ownpad",
    "\n    Create and open Etherpad and Ethercalc documents.\n  " : "\nCréer et ouvrir des documents Etherpad et Ethercalc.",
    "Ownpad is a Nextcloud application that allows to create and open\n    Etherpad and Ethercalc documents.\n\n    This application requires to have access to an instance of\n    Etherpad and/or Ethercalc to work properly." : "Ownpad est une application Nextcloud permettant de créer et d’ouvrir des documents Etherpad et Ethercalc.\n\nCette application nécessite de disposer d’un accès à une instance Etherpad et/ou Ethercalc pour fonctionner correctement.",
    "Pad" : "Pad",
